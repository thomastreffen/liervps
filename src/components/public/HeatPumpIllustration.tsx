...
export function HeatPumpIllustration({
  ...
  // Unique per instance so several illustrations on the same page never
  // produce duplicate SVG gradient ids in the DOM.
  const uid = useId().replace(/:/g, "");
  const idBody = `hpBody-${uid}`;
  const idFace = `hpFace-${uid}`;
  const idVent = `hpVent-${uid}`;
    ...
    <div className="aspect-[4/3] w-full bg-gradient-to-br from-[hsl(var(--warm-sand))] to-[hsl(var(--warm-beige))] flex flex-col items-center justify-center gap-2 px-4">
      ...
      >
        <defs>
          ...
          <linearGradient id={idFace} x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#ffffff" />
            <stop offset="62%" stopColor="#f7f9fb" />
            <stop offset="100%" stopColor="#e6ebf0" />
          </linearGradient>
          <linearGradient id={idVent} x1="0" y1="0" x2="0" y2="1">
        ...
        {variant === "water" ? (
          <>
            {/* outdoor unit */}
            <rect x="30" y="38" width="80" height="58" rx="8" fill={`url(#${idBody})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.35" strokeWidth="2" />
            ...
            {/* water tank */}
            <rect x="126" y="30" width="44" height="66" rx="10" fill={`url(#${idBody})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.35" strokeWidth="2" />
          ...
          <>
            ...
            <rect x="18" y="34" width="74" height="62" rx="6" fill={`url(#${idBody})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.3" strokeWidth="2" />
            {[0, 1, 2].map((r) =>
              [0, 1, 2].map((c) => (
                <rect
                  key={`${r}-${c}`}
            ...
            <rect x="104" y="46" width="72" height="50" rx="8" fill={`url(#${idBody})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.35" strokeWidth="2" />
          ...
          <>
            ...
            <rect x="16" y="30" width="70" height="20" rx="9" fill={`url(#${idBody})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.35" strokeWidth="2" />
            <line x1="24" y1="45" x2="78" y2="45" stroke="hsl(var(--mcs-navy))" strokeOpacity="0.25" strokeWidth="2" />
            <rect x="16" y="66" width="70" height="20" rx="9" fill={`url(#${idBody})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.35" strokeWidth="2" />
            <line x1="24" y1="81" x2="78" y2="81" stroke="hsl(var(--mcs-navy))" strokeOpacity="0.25" strokeWidth="2" />
            <rect x="112" y="44" width="66" height="50" rx="8" fill={`url(#${idBody})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.35" strokeWidth="2" />
          ...
          <>
            ...
            {variant === "floor" ? (
              <g>
                ...
                <rect x="54" y="44" width="92" height="60" rx="12" fill={`url(#${idFace})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.28" strokeWidth="1.6" />
                <path d="M62 50h76" stroke="#ffffff" strokeOpacity="0.9" strokeWidth="2" strokeLinecap="round" />
                <rect x="64" y="88" width="72" height="8" rx="4" fill={`url(#${idVent})`} />
              ...
              <g>
                ...
                <rect x="34" y="28" width="132" height="36" rx="17" fill={`url(#${idFace})`} stroke="hsl(var(--mcs-navy))" strokeOpacity="0.28" strokeWidth="1.6" />
                {/* top surface highlight */}
                <path d="M44 34h112" stroke="#ffffff" strokeOpacity="0.9" strokeWidth="2" strokeLinecap="round" />
                {/* louvre / air outlet */}
                <rect x="44" y="53" width="112" height="7" rx="3.5" fill={`url(#${idVent})`} />
